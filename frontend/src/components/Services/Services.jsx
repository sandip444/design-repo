...
const Services = () => {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row mt-6 px-5 font-red-rose space-y-6 md:space-y-0 md:space-x-6 mb-10">
       <div className="border border-[#E1E1E1] p-4 rounded-lg flex-1 px-5 py-4 shadow-drop-custom">
        ...
        <div className="border border-[#E1E1E1] p-4  rounded-lg flex-1 px-5 py-4 shadow-drop-custom" style={{flexDirection:"column"}}>
          <div className="flex items-center mb-4" >
